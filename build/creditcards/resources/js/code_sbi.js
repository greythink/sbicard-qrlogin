...
if (sHost=="sbicard.in.money.ge.com"||sHost=="www.sbicard.com"||sHost=="preprod.sbicard.com")
{
                var s_account="gemoneysinsbicard2"
}

else{
                var s_account="gemoneydinsbicard2"
}
...
s.linkInternalFilters="javascript:,uat.sbicard.in.money.ge.com,sbicard.com,sbicardtest.gecapital.in,qapreview.sbicard.com,qaprod.sbicard.com,sit.sbicardprod.in.money.ge.com,sbicard.in.money.ge.com,preprod.sbicard.com,devprod.sbicard.com,sit.sbicard.in.money.ge.com,"
...
function s_doPlugins(s) {
	...
	/*getQueryParam plugin starts*/

	   s.campaign=s.getValOnce(s.getQueryParam('gemid2'),"S_campaign",0);
	   /*getQueryParam plugin Complete*/

	/* New vs repeat visitor plugin starts*/
    s.prop9 = s.getNewRepeat();
	    /* New vs repeat visitor plugin Complete*/

	/* getDaysSinceLastVisit plugin starts*/
		s.prop8=s.getDaysSinceLastVisit('s_lv');
		/* getDaysSinceLastVisit plugin Complete*/

	/* getPercentPageViewed plugin starts*/
		s.prop7 = s.getPercentPageViewed();
		/* getPercentPageViewed plugin Complete*/
		}

		s.doPlugins = s_doPlugins;

	s.loadModule("Media")
s.Media.playerName="sbi videos";

s.Media.trackMilestones = "25,50,75,";
s.Media.segmentByMilestones = true;
s.Media.trackUsingContextData = true;
s.Media.contextDataMapping = {
  "a.media.name":"eVar7,prop15",
...
s.Media.trackVars="events,eVar7,prop15,eVar8";
...
s.visitorNamespace="gemoney"
s.trackingServer="somni.sbicard.com"

/************************** PLUGINS SECTION *************************/
/* You may insert any plugins you wish to use here.*/

/*Plugin: getNewRepeat 1.2 - Returns whether user is new or repeat starts*/
...
/*Plugin: getNewRepeat 1.2 - Returns whether user is new or repeat Complete*/

/*Plugin: Utility Function: split v1.5 (JS 1.0 compatible)*/
s.split=new Function("l","d",""
+"var i,x=0,a=new Array;while(l){i=l.indexOf(d);i=i>-1?i:l.length;a[x"
+"++]=l.substring(0,i);l=l.substring(i+d.length);}return a");
/*Plugin: Utility Function: split v1.5 ends */
